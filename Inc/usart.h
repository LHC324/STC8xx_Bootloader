...
#define RESET_OTA_RI() (S2CON &= ~S2RI)
#define OTA_UART_TI (S2CON & S2TI)
#define RESET_OTA_TI() (S2CON &= ~S2TI)
#define OTA_UART_SBUF S2BUF
...
#define uartx_rx_t Uartx_HandleTypeDef *

extern Uartx_HandleTypeDef Boot_Rx;
extern void Uart_PutByte(uint8_t str);
extern void Uart_PutString(uint8_t *pstr);
// extern void Uartx_RecivePackge(void);
#endif
